      ...
      TEST_state: begin
        ...
        case (M_test_counter_q)
          5'h00: begin
            ...
            if (M_shifter1_out != 16'h8000) begin
          ...
          5'h01: begin
            ...
            M_shifter1_a = 16'hffff;
            M_shifter1_b = 16'h000f;
            if (M_shifter1_out != 16'h0001) begin
              M_state_d = FAIL_state;
            end
          end
          5'h02: begin
            ...
            M_shifter1_a = 16'hffff;
            M_shifter1_b = 16'h000f;
            if (M_shifter1_out != 16'hffff) begin
              M_state_d = FAIL_state;
            end
          end
          5'h03: begin
            ...
            M_shifter1_b = 16'h000f;
            if (M_shifter1_out != 16'h0000) begin
              M_state_d = FAIL_state;
            end
          end
          5'h04: begin
          ...
          5'h06: begin
            ...
            if (M_shifter1_out != 16'hcd00) begin
              M_state_d = FAIL_state;
            end
          end
          5'h07: begin
            ...
            M_shifter1_b = 16'h0008;
            if (M_shifter1_out != 16'h00cd) begin
              M_state_d = FAIL_state;
            end
          end
          5'h08: begin
            ...
            M_shifter1_b = 16'h0008;
            if (M_shifter1_out != 16'h0030) begin
              M_state_d = FAIL_state;
            end
          end
          5'h1f: begin
